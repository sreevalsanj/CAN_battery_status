...
from can_msg_2 import Dataa

class demo(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
        # self.data=[["Controller Status",0],
                # ["CANopen error",0],
                # ["Error Registor",0],
                # ["FaultCode",0], 
                # ["Battery Discharge Limit",0],
                # ["BatteryChargeLimit",0], 
                # ["BatteryDischargeStatus",0], 
                # ["ChargeInterlockState",0], 
                # ["BatteryMPEStatus",0], 
                # ["Ready Power",0], 
                # ["Charge Power",0], 
                # ["ChargerHighestVoltage",0], 
                # ["ChargerHighestCurrent",0], 
                # ["ChargeStatus",0], 
                # ["Charger Mode",0], 
        ...
        self.data=[["BatteryCurrent",0],
                ["BatteryVoltage",0],
                ["BatterySOC",0],
                ["BatteryAmphours",0],
                ["BatteryHighestTemperature",0],
                ["HighestTemperatureThermistorID",0],
                ["BatteryLowestTemperature",0],
                ["HighestLowestThermistorID",0],
                ["BatteryAverageTemperature",0],
                ["BMSTemperature",0],
                ["BatteryAdaptiveSOC",0],
                ["BatteryAdaptiveAmphours",0],
                ["AuxilaryBatteryVoltage",0],
                ]   
                # ["BP Failsafe status",0],
                # ["DTC Status 1",0],
                # ["DTC Status 2",0],
                # ["Current Limit Status",0],
                # ["J1772CurrentLimit",0],
                # ["J1772PlugState",0],
                # ["BatteryAdaptiveTotalCapacity",0],
                # ["BatteryTotalCycles",0],
                # ["BatterySOH",0]
                # ]
